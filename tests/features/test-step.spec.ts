...
test.describe("Automation Exercise - Navigation",
  ...
  test("Should successfully visit product page", { tag: '@Happy-Path'}, async ({ page }) => {
    // Step 1
  ...
  test(
    ...
    {
      annotation: 
        { type: "issue", description: "can't search the product - https://github.com/jegspace/jegopez-playwright-basics/issues/1#issue-3277441925"}, 
